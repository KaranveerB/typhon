...
package net.zorgblub.typhonkai.fragment;
...
import net.zorgblub.typhonkai.Configuration.AnimationStyle;
import net.zorgblub.typhonkai.Configuration.ColourProfile;
import net.zorgblub.typhonkai.Configuration.ReadingDirection;
import net.zorgblub.typhonkai.Configuration.ScrollStyle;
import net.zorgblub.typhonkai.PlatformUtil;
import net.zorgblub.typhonkai.R;
import net.zorgblub.typhonkai.TextUtil;
import net.zorgblub.typhonkai.Typhon;
import net.zorgblub.typhonkai.activity.LibraryActivity;
import net.zorgblub.typhonkai.activity.MediaButtonReceiver;
import net.zorgblub.typhonkai.activity.ReadingActivity;
import net.zorgblub.typhonkai.animation.Animations;
import net.zorgblub.typhonkai.animation.Animator;
import net.zorgblub.typhonkai.animation.PageCurlAnimator;
import net.zorgblub.typhonkai.animation.PageTimer;
import net.zorgblub.typhonkai.animation.RollingBlindAnimator;
import net.zorgblub.typhonkai.bookmark.Bookmark;
import net.zorgblub.typhonkai.bookmark.BookmarkDatabaseHelper;
import net.zorgblub.typhonkai.dto.HighLight;
import net.zorgblub.typhonkai.dto.SearchResult;
import net.zorgblub.typhonkai.dto.TocEntry;
import net.zorgblub.typhonkai.epub.SearchTextTask;
import net.zorgblub.typhonkai.library.LibraryService;
import net.zorgblub.typhonkai.sync.AccessException;
import net.zorgblub.typhonkai.sync.BookProgress;
import net.zorgblub.typhonkai.sync.ProgressService;
import net.zorgblub.typhonkai.tts.TTSPlaybackItem;
import net.zorgblub.typhonkai.tts.TTSPlaybackQueue;
import net.zorgblub.typhonkai.view.AnimatedImageView;
import net.zorgblub.typhonkai.view.HighlightManager;
import net.zorgblub.typhonkai.view.NavGestureDetector;
import net.zorgblub.typhonkai.view.NavigationCallback;
import net.zorgblub.typhonkai.view.ProgressListAdapter;
import net.zorgblub.typhonkai.view.SearchResultAdapter;
import net.zorgblub.typhonkai.view.bookview.BookView;
import net.zorgblub.typhonkai.view.bookview.BookViewListener;
import net.zorgblub.typhonkai.view.bookview.SelectedWord;
import net.zorgblub.typhonkai.view.bookview.TextLoader;
import net.zorgblub.typhonkai.view.bookview.TextSelectionCallback;
...
import static net.zorgblub.typhonkai.PlatformUtil.executeTask;
